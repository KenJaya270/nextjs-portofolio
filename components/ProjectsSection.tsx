...
const ProjectsSection = () => {
  return (
    <div className='sm:flex sm:flex-col sm:justify-center'>
      <div className="my-10">
        <h1 className="mb-3 font-semibold md:text-4xl sm:text-2xl tracking-[0.3rem] ssm:text-center md:text-justify">
          Projects
        </h1>
        <p className="sm:text-xl md:text-3xl ssm:text-center md:text-justify">Projects that I create at school and also in my spare time</p>
      </div>
          ...
          return(
            <div key={idx}>
              <div className="flex sm:justify-center">
                <div className="md:flex sm:flex-col md:flex-row ssm:space-y-4 md:space-x-4">
                  <div className="group">
                  ...
                  <div className=''>
                    <h1 className="font-semibold text-[1.4rem] mb-3 ssm:text-center md:text-justify">{project.name}</h1>
                    <p className='text-[1.1rem] text-black ssm:text-center md:text-justify'>{project.description}</p>
                    <Link className="group ssm:flex ssm:justify-center md:justify-start" href={project.github}>
